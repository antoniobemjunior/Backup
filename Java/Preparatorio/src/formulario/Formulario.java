	...
	public Formulario() {
		...
		btnQuantidade.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Produto 1: "+Produto.prod1+"\n"+
													"Produto 2: "+Produto.prod2+"\n"+
													"Produto 3: "+Produto.prod3+"\n"+
													"Produto 4: "+Produto.prod4+"\n"+
													"Produto 5: "+Produto.prod5+"\n"+
													"Produto 6: "+Produto.prod6+"\n"+
													"Produto 7: "+Produto.prod7+"\n"+
													"Produto 8: "+Produto.prod8+"\n");
			}
		});
